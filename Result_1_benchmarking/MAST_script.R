...
## Load data
exp_data <- read.csv(paste0(out_dir, '/ExpressionData.csv'), header = TRUE, row.names = 1)
# exp_data <- t(exp_data)
pseudotime_lineages <- read.csv(paste0(out_dir, '/PseudoTime.csv'), header = TRUE, row.names = 1)
